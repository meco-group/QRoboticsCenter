    ...
    _stackdown_action(new QAction("prev",this))
{
    ...
    QObject::connect(_stackup_action,&QAction::triggered,this,&QStackedWindow::stackUp);
    addAction(_stackup_action);

    // Stack down action
    _stackdown_action = new QAction("prev",this);
    _stackdown_action->setShortcut(Qt::CTRL + Qt::Key_Left);
    QObject::connect(_stackdown_action,&QAction::triggered,this,&QStackedWindow::stackDown);
