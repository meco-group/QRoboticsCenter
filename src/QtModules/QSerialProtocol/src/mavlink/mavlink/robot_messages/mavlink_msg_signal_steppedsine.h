...
#define MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_MIN_LEN 19
#define MAVLINK_MSG_ID_82_LEN 19
#define MAVLINK_MSG_ID_82_MIN_LEN 19
                               ...
                               uint16_t channels, float fmin, float fmax, uint8_t period, float stepsize, float amplitude)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_LEN, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_CRC);
}
                                   ...
                                   uint16_t channels,float fmin,float fmax,uint8_t period,float stepsize,float amplitude)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_LEN, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_CRC);
}
...
static inline void mavlink_msg_signal_steppedsine_send(mavlink_channel_t chan, uint16_t channels, float fmin, float fmax, uint8_t period, float stepsize, float amplitude)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE, buf, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_LEN, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_CRC);
#else
    mavlink_signal_steppedsine_t packet;
    packet.fmin = fmin;
    packet.fmax = fmax;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE, (const char *)&packet, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_LEN, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_signal_steppedsine_send_struct(mavlink_channel_t chan, const mavlink_signal_steppedsine_t* signal_steppedsine)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_signal_steppedsine_send(chan, signal_steppedsine->channels, signal_steppedsine->fmin, signal_steppedsine->fmax, signal_steppedsine->period, signal_steppedsine->stepsize, signal_steppedsine->amplitude);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE, (const char *)signal_steppedsine, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_LEN, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_LEN? msg->len : MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_LEN;
        memset(signal_steppedsine, 0, MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_LEN);
    memcpy(signal_steppedsine, _MAV_PAYLOAD(msg), len);
#endif
}
