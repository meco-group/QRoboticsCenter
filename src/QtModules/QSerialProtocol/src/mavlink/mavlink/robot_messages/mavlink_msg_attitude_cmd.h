...
#define MAVLINK_MSG_ID_ATTITUDE_CMD_MIN_LEN 12
#define MAVLINK_MSG_ID_54_LEN 12
#define MAVLINK_MSG_ID_54_MIN_LEN 12
                               ...
                               int16_t roll, int16_t pitch, int16_t yaw, int16_t rollFF, int16_t pitchFF, int16_t yawFF)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ATTITUDE_CMD_MIN_LEN, MAVLINK_MSG_ID_ATTITUDE_CMD_LEN, MAVLINK_MSG_ID_ATTITUDE_CMD_CRC);
}
                                   ...
                                   int16_t roll,int16_t pitch,int16_t yaw,int16_t rollFF,int16_t pitchFF,int16_t yawFF)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_ATTITUDE_CMD;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ATTITUDE_CMD_MIN_LEN, MAVLINK_MSG_ID_ATTITUDE_CMD_LEN, MAVLINK_MSG_ID_ATTITUDE_CMD_CRC);
}
...
static inline void mavlink_msg_attitude_cmd_send(mavlink_channel_t chan, int16_t roll, int16_t pitch, int16_t yaw, int16_t rollFF, int16_t pitchFF, int16_t yawFF)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_CMD, buf, MAVLINK_MSG_ID_ATTITUDE_CMD_MIN_LEN, MAVLINK_MSG_ID_ATTITUDE_CMD_LEN, MAVLINK_MSG_ID_ATTITUDE_CMD_CRC);
#else
    mavlink_attitude_cmd_t packet;
    packet.roll = roll;
    packet.pitch = pitch;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_CMD, (const char *)&packet, MAVLINK_MSG_ID_ATTITUDE_CMD_MIN_LEN, MAVLINK_MSG_ID_ATTITUDE_CMD_LEN, MAVLINK_MSG_ID_ATTITUDE_CMD_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_attitude_cmd_send_struct(mavlink_channel_t chan, const mavlink_attitude_cmd_t* attitude_cmd)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_attitude_cmd_send(chan, attitude_cmd->roll, attitude_cmd->pitch, attitude_cmd->yaw, attitude_cmd->rollFF, attitude_cmd->pitchFF, attitude_cmd->yawFF);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ATTITUDE_CMD, (const char *)attitude_cmd, MAVLINK_MSG_ID_ATTITUDE_CMD_MIN_LEN, MAVLINK_MSG_ID_ATTITUDE_CMD_LEN, MAVLINK_MSG_ID_ATTITUDE_CMD_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_ATTITUDE_CMD_LEN? msg->len : MAVLINK_MSG_ID_ATTITUDE_CMD_LEN;
        memset(attitude_cmd, 0, MAVLINK_MSG_ID_ATTITUDE_CMD_LEN);
    memcpy(attitude_cmd, _MAV_PAYLOAD(msg), len);
#endif
}
