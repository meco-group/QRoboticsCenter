...
#define MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_MIN_LEN 18
#define MAVLINK_MSG_ID_80_LEN 18
#define MAVLINK_MSG_ID_80_MIN_LEN 18
                               ...
                               uint16_t channels, float fmin, float fmax, float period, float amplitude)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_LEN, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_CRC);
}
                                   ...
                                   uint16_t channels,float fmin,float fmax,float period,float amplitude)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_SIGNAL_SWEPTSINE;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_LEN, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_CRC);
}
...
static inline void mavlink_msg_signal_sweptsine_send(mavlink_channel_t chan, uint16_t channels, float fmin, float fmax, float period, float amplitude)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE, buf, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_LEN, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_CRC);
#else
    mavlink_signal_sweptsine_t packet;
    packet.fmin = fmin;
    packet.fmax = fmax;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE, (const char *)&packet, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_LEN, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_signal_sweptsine_send_struct(mavlink_channel_t chan, const mavlink_signal_sweptsine_t* signal_sweptsine)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_signal_sweptsine_send(chan, signal_sweptsine->channels, signal_sweptsine->fmin, signal_sweptsine->fmax, signal_sweptsine->period, signal_sweptsine->amplitude);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE, (const char *)signal_sweptsine, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_LEN, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_LEN? msg->len : MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_LEN;
        memset(signal_sweptsine, 0, MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_LEN);
    memcpy(signal_sweptsine, _MAV_PAYLOAD(msg), len);
#endif
}
