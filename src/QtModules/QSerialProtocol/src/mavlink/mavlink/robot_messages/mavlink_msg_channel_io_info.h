...
#define MAVLINK_MSG_ID_CHANNEL_IO_INFO_MIN_LEN 5
                               ...
                               uint8_t type, uint8_t configuration, uint8_t excitation, uint8_t version, uint8_t subversion)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_CHANNEL_IO_INFO_MIN_LEN, MAVLINK_MSG_ID_CHANNEL_IO_INFO_LEN, MAVLINK_MSG_ID_CHANNEL_IO_INFO_CRC);
}
                                   ...
                                   uint8_t type,uint8_t configuration,uint8_t excitation,uint8_t version,uint8_t subversion)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_CHANNEL_IO_INFO;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_CHANNEL_IO_INFO_MIN_LEN, MAVLINK_MSG_ID_CHANNEL_IO_INFO_LEN, MAVLINK_MSG_ID_CHANNEL_IO_INFO_CRC);
}
...
static inline void mavlink_msg_channel_io_info_send(mavlink_channel_t chan, uint8_t type, uint8_t configuration, uint8_t excitation, uint8_t version, uint8_t subversion)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CHANNEL_IO_INFO, buf, MAVLINK_MSG_ID_CHANNEL_IO_INFO_MIN_LEN, MAVLINK_MSG_ID_CHANNEL_IO_INFO_LEN, MAVLINK_MSG_ID_CHANNEL_IO_INFO_CRC);
#else
    mavlink_channel_io_info_t packet;
    packet.type = type;
    packet.configuration = configuration;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CHANNEL_IO_INFO, (const char *)&packet, MAVLINK_MSG_ID_CHANNEL_IO_INFO_MIN_LEN, MAVLINK_MSG_ID_CHANNEL_IO_INFO_LEN, MAVLINK_MSG_ID_CHANNEL_IO_INFO_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_channel_io_info_send_struct(mavlink_channel_t chan, const mavlink_channel_io_info_t* channel_io_info)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_channel_io_info_send(chan, channel_io_info->type, channel_io_info->configuration, channel_io_info->excitation, channel_io_info->version, channel_io_info->subversion);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CHANNEL_IO_INFO, (const char *)channel_io_info, MAVLINK_MSG_ID_CHANNEL_IO_INFO_MIN_LEN, MAVLINK_MSG_ID_CHANNEL_IO_INFO_LEN, MAVLINK_MSG_ID_CHANNEL_IO_INFO_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_CHANNEL_IO_INFO_LEN? msg->len : MAVLINK_MSG_ID_CHANNEL_IO_INFO_LEN;
        memset(channel_io_info, 0, MAVLINK_MSG_ID_CHANNEL_IO_INFO_LEN);
    memcpy(channel_io_info, _MAV_PAYLOAD(msg), len);
#endif
}
