...
#define MAVLINK_MSG_ID_VELOCITY_CMD_MIN_LEN 12
#define MAVLINK_MSG_ID_55_LEN 12
#define MAVLINK_MSG_ID_55_MIN_LEN 12
                               ...
                               int16_t vx, int16_t vy, int16_t vz, int16_t vxFF, int16_t vyFF, int16_t vzFF)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_VELOCITY_CMD_MIN_LEN, MAVLINK_MSG_ID_VELOCITY_CMD_LEN, MAVLINK_MSG_ID_VELOCITY_CMD_CRC);
}
                                   ...
                                   int16_t vx,int16_t vy,int16_t vz,int16_t vxFF,int16_t vyFF,int16_t vzFF)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_VELOCITY_CMD;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_VELOCITY_CMD_MIN_LEN, MAVLINK_MSG_ID_VELOCITY_CMD_LEN, MAVLINK_MSG_ID_VELOCITY_CMD_CRC);
}
...
static inline void mavlink_msg_velocity_cmd_send(mavlink_channel_t chan, int16_t vx, int16_t vy, int16_t vz, int16_t vxFF, int16_t vyFF, int16_t vzFF)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VELOCITY_CMD, buf, MAVLINK_MSG_ID_VELOCITY_CMD_MIN_LEN, MAVLINK_MSG_ID_VELOCITY_CMD_LEN, MAVLINK_MSG_ID_VELOCITY_CMD_CRC);
#else
    mavlink_velocity_cmd_t packet;
    packet.vx = vx;
    packet.vy = vy;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VELOCITY_CMD, (const char *)&packet, MAVLINK_MSG_ID_VELOCITY_CMD_MIN_LEN, MAVLINK_MSG_ID_VELOCITY_CMD_LEN, MAVLINK_MSG_ID_VELOCITY_CMD_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_velocity_cmd_send_struct(mavlink_channel_t chan, const mavlink_velocity_cmd_t* velocity_cmd)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_velocity_cmd_send(chan, velocity_cmd->vx, velocity_cmd->vy, velocity_cmd->vz, velocity_cmd->vxFF, velocity_cmd->vyFF, velocity_cmd->vzFF);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VELOCITY_CMD, (const char *)velocity_cmd, MAVLINK_MSG_ID_VELOCITY_CMD_MIN_LEN, MAVLINK_MSG_ID_VELOCITY_CMD_LEN, MAVLINK_MSG_ID_VELOCITY_CMD_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_VELOCITY_CMD_LEN? msg->len : MAVLINK_MSG_ID_VELOCITY_CMD_LEN;
        memset(velocity_cmd, 0, MAVLINK_MSG_ID_VELOCITY_CMD_LEN);
    memcpy(velocity_cmd, _MAV_PAYLOAD(msg), len);
#endif
}
