...
#define MAVLINK_MSG_ID_POSITION_CMD_MIN_LEN 18
                               ...
                               int32_t x, int32_t y, int32_t z, int16_t xFF, int16_t yFF, int16_t zFF)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_POSITION_CMD_MIN_LEN, MAVLINK_MSG_ID_POSITION_CMD_LEN, MAVLINK_MSG_ID_POSITION_CMD_CRC);
}
                                   ...
                                   int32_t x,int32_t y,int32_t z,int16_t xFF,int16_t yFF,int16_t zFF)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_POSITION_CMD;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_POSITION_CMD_MIN_LEN, MAVLINK_MSG_ID_POSITION_CMD_LEN, MAVLINK_MSG_ID_POSITION_CMD_CRC);
}
...
static inline void mavlink_msg_position_cmd_send(mavlink_channel_t chan, int32_t x, int32_t y, int32_t z, int16_t xFF, int16_t yFF, int16_t zFF)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POSITION_CMD, buf, MAVLINK_MSG_ID_POSITION_CMD_MIN_LEN, MAVLINK_MSG_ID_POSITION_CMD_LEN, MAVLINK_MSG_ID_POSITION_CMD_CRC);
#else
    mavlink_position_cmd_t packet;
    packet.x = x;
    packet.y = y;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POSITION_CMD, (const char *)&packet, MAVLINK_MSG_ID_POSITION_CMD_MIN_LEN, MAVLINK_MSG_ID_POSITION_CMD_LEN, MAVLINK_MSG_ID_POSITION_CMD_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_position_cmd_send_struct(mavlink_channel_t chan, const mavlink_position_cmd_t* position_cmd)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_position_cmd_send(chan, position_cmd->x, position_cmd->y, position_cmd->z, position_cmd->xFF, position_cmd->yFF, position_cmd->zFF);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_POSITION_CMD, (const char *)position_cmd, MAVLINK_MSG_ID_POSITION_CMD_MIN_LEN, MAVLINK_MSG_ID_POSITION_CMD_LEN, MAVLINK_MSG_ID_POSITION_CMD_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_POSITION_CMD_LEN? msg->len : MAVLINK_MSG_ID_POSITION_CMD_LEN;
        memset(position_cmd, 0, MAVLINK_MSG_ID_POSITION_CMD_LEN);
    memcpy(position_cmd, _MAV_PAYLOAD(msg), len);
#endif
}
