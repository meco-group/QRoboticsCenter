...
#define MAVLINK_MSG_ID_51_MIN_LEN 28
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_attitude_send(chan, attitude->time, attitude->roll, attitude->pitch, attitude->yaw, attitude->roll_cmd, attitude->pitch_cmd, attitude->yaw_cmd, attitude->roll_act, attitude->pitch_act, attitude->yaw_act, attitude->roll_cont, attitude->pitch_cont, attitude->yaw_cont);
#else
