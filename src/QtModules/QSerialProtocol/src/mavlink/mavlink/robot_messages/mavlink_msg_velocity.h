...
#define MAVLINK_MSG_ID_VELOCITY_MIN_LEN 28
#define MAVLINK_MSG_ID_52_LEN 28
#define MAVLINK_MSG_ID_52_MIN_LEN 28
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_velocity_send(chan, velocity->time, velocity->vx, velocity->vy, velocity->vz, velocity->vx_cmd, velocity->vy_cmd, velocity->vz_cmd, velocity->vx_act, velocity->vy_act, velocity->vz_act, velocity->vx_cont, velocity->vy_cont, velocity->vz_cont);
#else
