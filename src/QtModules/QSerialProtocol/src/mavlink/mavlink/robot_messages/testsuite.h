...
static void mavlink_test_position(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_position_t packet_in = {
        963497464,963497672,963497880,963498088,963498296,963498504,963498712,18691,18795,18899,19003,19107,19211
    };
...
static void mavlink_test_attitude_cmd(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_ATTITUDE_CMD >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_attitude_cmd_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_ATTITUDE_CMD_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_ATTITUDE_CMD_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_velocity_cmd(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_VELOCITY_CMD >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_velocity_cmd_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_VELOCITY_CMD_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_VELOCITY_CMD_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_position_cmd(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_POSITION_CMD >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_position_cmd_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_POSITION_CMD_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_POSITION_CMD_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_radar_cloud(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_RADAR_CLOUD >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_radar_cloud_t packet_in = {
        { 963497464, 963497465, 963497466, 963497467, 963497468, 963497469 },{ 963498712, 963498713, 963498714, 963498715, 963498716, 963498717 }
    };
    mavlink_radar_cloud_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_RADAR_CLOUD_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_RADAR_CLOUD_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_radar_line(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_RADAR_LINE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_radar_line_t packet_in = {
        { 963497464, 963497465 },{ 963497880, 963497881 }
    };
    mavlink_radar_line_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_RADAR_LINE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_RADAR_LINE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_signal_sweptsine(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SIGNAL_SWEPTSINE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_signal_sweptsine_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SIGNAL_SWEPTSINE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_signal_multisine(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SIGNAL_MULTISINE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_signal_multisine_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SIGNAL_MULTISINE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SIGNAL_MULTISINE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_signal_steppedsine(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_signal_steppedsine_t packet_in = {
        17.0,45.0,73.0,101.0,18067,187
    };
    mavlink_signal_steppedsine_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SIGNAL_STEPPEDSINE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_channel_io(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CHANNEL_IO >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_channel_io_t packet_in = {
        963497464,{ 45.0, 46.0, 47.0, 48.0, 49.0, 50.0 },{ 213.0, 214.0, 215.0, 216.0, 217.0, 218.0 },161
    };
    mavlink_channel_io_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CHANNEL_IO_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CHANNEL_IO_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
...
static void mavlink_test_channel_io_info(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CHANNEL_IO_INFO >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_channel_io_info_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CHANNEL_IO_INFO_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CHANNEL_IO_INFO_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
