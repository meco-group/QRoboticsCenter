...
#define MAVLINK_MSG_ID_SIGNAL_MULTISINE_MIN_LEN 7
#define MAVLINK_MSG_ID_81_LEN 7
#define MAVLINK_MSG_ID_81_MIN_LEN 7
                               ...
                               uint16_t channels, uint8_t id, float amplitude)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_SIGNAL_MULTISINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_MULTISINE_LEN, MAVLINK_MSG_ID_SIGNAL_MULTISINE_CRC);
}
                                   ...
                                   uint16_t channels,uint8_t id,float amplitude)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_SIGNAL_MULTISINE;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_SIGNAL_MULTISINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_MULTISINE_LEN, MAVLINK_MSG_ID_SIGNAL_MULTISINE_CRC);
}
...
static inline void mavlink_msg_signal_multisine_send(mavlink_channel_t chan, uint16_t channels, uint8_t id, float amplitude)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SIGNAL_MULTISINE, buf, MAVLINK_MSG_ID_SIGNAL_MULTISINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_MULTISINE_LEN, MAVLINK_MSG_ID_SIGNAL_MULTISINE_CRC);
#else
    mavlink_signal_multisine_t packet;
    packet.amplitude = amplitude;
    packet.channels = channels;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SIGNAL_MULTISINE, (const char *)&packet, MAVLINK_MSG_ID_SIGNAL_MULTISINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_MULTISINE_LEN, MAVLINK_MSG_ID_SIGNAL_MULTISINE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_signal_multisine_send_struct(mavlink_channel_t chan, const mavlink_signal_multisine_t* signal_multisine)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_signal_multisine_send(chan, signal_multisine->channels, signal_multisine->id, signal_multisine->amplitude);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SIGNAL_MULTISINE, (const char *)signal_multisine, MAVLINK_MSG_ID_SIGNAL_MULTISINE_MIN_LEN, MAVLINK_MSG_ID_SIGNAL_MULTISINE_LEN, MAVLINK_MSG_ID_SIGNAL_MULTISINE_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_SIGNAL_MULTISINE_LEN? msg->len : MAVLINK_MSG_ID_SIGNAL_MULTISINE_LEN;
        memset(signal_multisine, 0, MAVLINK_MSG_ID_SIGNAL_MULTISINE_LEN);
    memcpy(signal_multisine, _MAV_PAYLOAD(msg), len);
#endif
}
